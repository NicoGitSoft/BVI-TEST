...
# Leer los datos del archivos .csv
data = pd.read_csv("Temperaturas1VPU.csv")
# define my data
start_sample = 50
samples = len(data) # número de muestras
n = np.linspace(0, 3600, samples - start_sample) # tiempo en segundos
times = data[0][start_sample:samples] # vector de tiempos	
chipTemperature = data[1][start_sample:samples] # vector de temperaturas
cpuTemperature = data[2][start_sample:samples] # vector de temperaturas
max6675Temperature = data[2][start_sample:samples] # vector de temperaturas
