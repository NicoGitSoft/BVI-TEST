...
# vertor de nuestras
n0 = np.arange(0, len(file0['TIMES'][start_sample:]))
n1 = np.arange(0, len(file1['TIMES'][start_sample:]))
n2 = np.arange(0, len(file2['TIMES'][start_sample:]))

DELTA_VPU_MAX6675 = 12.028342016016863

# datos del archivo 0
VPU_TEMPERATURE_0 = file0['VPU'][start_sample:]
CPU_TEMPERATURE_0 = file0['CPU'][start_sample:]
MAX6675_TEMPERATURE_0 = file0['THERMOCOUPLE'][start_sample:] - DELTA_VPU_MAX6675
